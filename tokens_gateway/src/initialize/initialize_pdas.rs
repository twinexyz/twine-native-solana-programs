...
use crate::core::state::{
    NativeTokenVaultData, SplTokensVault, TokenDecimalMappings, TokensGatewayRoleManager,TokenDepositData
};
...
pub fn initialize_pdas(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    ...
    invoke_signed(
      ...
      invoke_signed(
          ...
          &[chain_admin.clone(), spl_tokens_vault_data.clone(), system_program.clone()],
