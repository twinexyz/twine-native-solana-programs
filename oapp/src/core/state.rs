...
pub const ENDPOINT_SET_CONFIG_DISCEIMINATOR: [u8; 8] = [0x6c, 0x9e, 0x9a, 0xaf, 0xd4, 0x62, 0x34, 0x42];
pub const ENDPOINT_SET_SEND_LIB_DISCRIMINATOR: [u8; 8] = [0x97, 0xf8, 0x5f, 0x9e, 0xfc, 0x28, 0x97, 0xf5];
pub const ENDPOINT_REGISTER_OAPP_DISCRIMINATOR: [u8; 8] = [0x81, 0x59, 0x47, 0x44, 0x0B, 0x52, 0xD2, 0x7D];
