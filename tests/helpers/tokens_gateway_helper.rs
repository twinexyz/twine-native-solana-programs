...
use tokens_gateway::{
    core::{processor as tokens_gateway_processor, state::SignMessageInfo},
    utils::address_derivation::derive_gateway_role_manager,
    ID as tokens_gateway_ID,
};
use twine_chain::{core::processor as twine_chain_processor, ID as twine_chain_ID};
...
impl Default for TokensGatewayAccounts {
    fn default() -> Self {
        ...
        Self {
            role_manager: derive_gateway_role_manager(&tokens_gateway_ID).0,
            chain_admin,
